...
class UserController extends BaseController {
    ...
    {
        $origin = base64_decode(Input::get('origin'));
        ...
        if ( Confide::logAttempt( $input, Config::get('confide::signup_confirm') ) ) 
        {
            ...
            // Fix pull #145
            return Redirect::intended('/'.$origin); // change it to '/admin', '/dashboard' or something
        }
        else
        {
            $user = new User;
            ...
            if($origin == 'checkout') {
                return Redirect::to('checkout')->withInput(Input::except('password'))->with( 'error', $err_msg );
            }
    ...
    public function logout()
    {
        ...
        //destroy the cart when logging out
        Cart::destroy();
