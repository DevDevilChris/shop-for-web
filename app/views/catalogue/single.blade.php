...
<div class="row">
    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
        <img src="holder.js/100%x500" alt="" class="img-rounded" />
    </div>
    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
        <h2>{{ $product->name }}</h2>
        <p class="lead">
        ...
        <p>
            <div class="input-group col-lg-4 pull-left">
                {{ Form::text('product_qty', 1, array('class'=>'form-control', 'onblur'=>'javascript: if(this.value == "") { this.value = 1 } else { this.value } ;')) }}
